$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSflH7OCq1t7theoNZbGS5NazFsMgZNFQn7oEllZAkOaxVMNlQ/formResponse");
...
function maxLengthCheck(object){
 ...
 function hoa(){ 
        ...
        $(window).scrollTop(0);
        window.location.href = './miz-result.html';
 }
 ...
 function form_check(){
    ...
    // {
            ...
            if(regex1.test(name) && name.length > 1 )
            {
                    ...
                    if(regex.test(age) && age.length == 2 && age >=35 && age <56)
                    {
                    ...
                    $('#send_message').css({transition:"1s"});
                    $('#send_message').prop("disabled", true);
                    $('#send_message').prop("value", "35세 ~ 55세 까지 가능합니다.");
                    $('#send_message').css({background:"#121212"});
                    $('#send_message').css({cursor:"default"});     
                    }
