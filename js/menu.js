            ...
            <div class="menu02"><!-- 메뉴 2depth-->
                ...
                <div class="menu-02">
                    <div class="set-con">
                        ...
                        <li><p><a target="_self" href="./tarot-card.html">  <img src="img/lic_favicon.png" style="width:20px;margin-right:4px;margin-bottom:4px;">타로심리상담사 <span class="blink menu_event"> 무료 기출 문제</span><br><span class="menu_ex">[시급 기본 6만원, 재택근무 가능, 시간 조절 가능]</span></a></p></li>
